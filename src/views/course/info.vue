    ...
    <el-form label-width="120px">
      ...
      <el-form-item label="课程封面">
        ...
        <el-upload
          ...
          <img :src="courseInfo.course.cover" width="100" height="100">
        </el-upload>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      subjectLevelOneChanged(value) {  //value=subject.id
        console.log(value)
      ...
      fetchCourseInfoById(id){
        course.getCourseInfoById(id).then(response=>{
          ...
          console.log("courseInfo:"+this.courseInfo.course.subjectParentId)
          // 初始化分类列表
